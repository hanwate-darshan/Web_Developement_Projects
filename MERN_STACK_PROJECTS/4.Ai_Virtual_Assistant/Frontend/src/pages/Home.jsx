...
//       <button className='' onClick={()=>navigate("/customize")}> Customize your account</button>
       


//       <div className='w-100 h-100 flex flex-col justify-center items-center overflow-hidden rounded-2xl shadow-lg gap-5'>
